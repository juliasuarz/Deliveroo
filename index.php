            ...
            <div class="navbar">
                <div class="container-fluid menu-p">
                    <div class="col col-logo">
                        <a href="principal.php"><img class="logo-img" src="./img/deliveroo-logo.png" id="inicio"></a>
                    </div>
                    <div>
        ...
        <div class="col-opt">
            ...
            <div class="filtros filtros-tipo-dieta">
                <div class="desplegable" id="desplegable1">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="precio" id="precio0" value="">
                        <label class="form-check-label" onclick="setTimeout(ListarRestaurantes, 100)" for="precio0">Cualquier</label>
                    </div>
                    <div class="form-check">
            ...
            <div class="filtros filtros-tipo-dieta">
                ...
                <div class="desplegador">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="valoracion" id="valoracion0" value="">
                        <label class="form-check-label" onclick="setTimeout(ListarRestaurantes, 100)" for="valoracion0">Qualquier</label>
                    </div>
                    <div class="form-check">
